...
| Gemini 3.5+ used | `gemini-3.7-flash` is now the configured default, satisfying the 3.5+ floor | NOT YET as live model use; live inference evidence still required |
...
Evidence for the first deterministic gate: [`evidence/CI_RUN_33043470358.md`](evidence/CI_RUN_33043470358.md).
